...
const ipcMocks = vi.hoisted(() => ({
  ...
  // D-048 / t_4bd214de: MCP daemon 桥 mock(供 SettingsView 嵌入的 McpServicePanel 调用)
  mcpProbe: vi.fn(),
  mcpStart: vi.fn(),
  mcpStop: vi.fn(),
  mcpGetConfig: vi.fn(),
...
beforeEach(() => {
  ...
  // D-048 / t_4bd214de: MCP 默认 happy path mock, 各 it 单独覆盖
...
describe("MCP 服务区块(D-048 / t_4bd214de)", () => {
